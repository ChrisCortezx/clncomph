...
Tested up to: WordPress 3.3.2 / BuddyPress 1.5.5
Stable tag: 1.2
...
Missing crumbs?  Find them with Breadcrumbs Everywhere! This plugin adds breadcrumb trail navigation to BuddyPress 1.5.x.  Simple, just add one line of code to your template. You don't need to use it, but there is an admin feature, too. 

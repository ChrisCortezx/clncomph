		...
		<?php endif; // -------------------------- ?>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<input name="crumbs-setting-one" type="text" id="crumbs-setting-one" value="<?php echo esc_attr( $setting_one ); ?>" size="60" />
					</td>
				</tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Text for the Blog link:', 'crumbs' ) ?></label></th>
					<td>
						<input name="crumbs-setting-two" type="text" id="crumbs-setting-two" value="<?php echo esc_attr( $setting_two ); ?>" size="60" />
					</td>
				</tr>
                </tr>
					<th scope="row"><label for="target_uri"><?php _e( 'Breadcrumb divider:', 'crumbs' ) ?></label></th>
					<td>
						<input name="crumbs-setting-three" type="text" id="crumbs-setting-three" value="<?php echo htmlentities( $setting_three ); ?>" size="60" />
					</td>
				</tr>
			</table>
			<p class="submit">

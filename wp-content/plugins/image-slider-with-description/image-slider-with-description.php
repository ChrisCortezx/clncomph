...
function ImgSlider_admin_options() 
{
	...
	echo '<p>Fade Speed :<br><input  style="width: 150px;" maxlength="3" type="text" value="5000"';
	...
	echo '<p>Fade Speed :<br><input  style="width: 150px;" type="text" maxlength="3" value="5000"';
...
$Slider = $Slider . 'height:'.$sliderHeight.'px; ';$Slider = $Slider . 'width:'.$sliderWidth.'px; ';
